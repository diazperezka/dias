...
const initFrom = zonedTimeToUtc("2021-07-01", "America/Santiago");
const initTo = zonedTimeToUtc("2021-07-27", "America/Santiago");

let from = zonedTimeToUtc("2021-07-01", "America/Santiago");
let to = zonedTimeToUtc("2021-07-27", "America/Santiago");
...
console.log("[blocksWithDate]", blocksWithDate);
